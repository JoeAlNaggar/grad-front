...
import { Home, BoxIcon as Toolbox, Users, Lightbulb, Plus, ArrowLeft, Wrench, Sparkles, Sliders, X , Settings, FileText} from "lucide-react"
...
const navItems = [
  ...
  },
  {
    ...
    subItems: [
      { icon: FileText, label: "Profile Setup", href: "/settings/profile-setup" },
      { icon: FileText, label: "Profile Content", href: "/settings/profile-content" },
      { icon: Sliders, label: "Settings Management", href: "/settings/management" },
    ],
  },
